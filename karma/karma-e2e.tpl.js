module.exports = function ( karma ) {
  karma.set({
    ...
    files: [
      ...
      'src/app/*.scenario.*',
      'src/app/enroll/start/*.scenario.*',
      'src/app/enroll/starter-packs/*.scenario.*',
      'src/app/enroll/auto-refill/*.scenario.*',
      'src/app/enroll/account-setup/*.scenario.*',
      'src/app/enroll/payment/*.scenario.*',
      'src/app/enroll/summary/*.scenario.*',
      'src/app/enroll/success/*.scenario.*',
      'src/**/*.scenario.*',
